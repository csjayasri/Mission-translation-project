...
Overview This project uses the Helsinki-NLP/opus-mt-en-fr model (MarianMT) to perform high-quality text translation. It leverages deep learning to provide context-aware translations rather than simple word-for-word replacement.

Tech Stack Framework:PyTorch or TensorFlow Library:Hugging Face transformers Model:MarianMT (Helsinki-NLP)
